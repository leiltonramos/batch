@ SCRIPT PARA ELIMINACAO DE ARQUIVOS TEMPORARIOS
...
rmdir /q /s C:\Users\%USERNAME%\AppData\Local\Vivaldi\"User Data"\Default\Cache\Cache_Data\
rmdir /q /s C:\Users\%USERNAME%\AppData\Local\Vivaldi\"User Data"\Default\IndexedDB\
